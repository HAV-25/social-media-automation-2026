...
export const serverEnvSchema = envSchema
  .extend({
    ...
    AI_WRITE_REASONING_EFFORT: z.enum(["none", "low", "medium", "high", "xhigh"]).default("none"),
    ...
    AI_WRITE_MAX_OUTPUT_TOKENS: z.coerce.number().int().min(500).max(16_000).default(2_500),
